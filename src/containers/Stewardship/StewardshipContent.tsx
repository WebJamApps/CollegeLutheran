    ...
    <div className="container-fluid">
      ...
      >
        ...
        <i style={{ fontSize: '10pt' }}>
          Coming soon, an online way to provide your 2025 Statement of Intent.
        </i>
        <p style={{ marginTop: '12px' }}>
          Dear members and friends of College Lutheran Church,
        </p>
        <p>
          This year, our fall Stewardship Appeal will celebrate the “varieties of gifts, but the same Spirit”
          (First Corinthians 12:4) that we see evident in and through the many ministries of College Lutheran Church.
        ...
        <p>
          In the weeks ahead you will be hearing more about our ministry plans for 2025.
          ...
          Looking ahead to 2025 means celebrating the journey we have been traveling
        ...
        <p>
          ...
          Then, on Sunday, October 13, we will observe Stewardship Sunday by
        ...
        <p style={{ marginBottom: '0px' }}>
          Pastor David Drebes & Congregation Council President Bob Yates
        </p>
      </div>
      <ELCALogo />
    </div>
