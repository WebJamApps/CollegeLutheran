        ...
        <div>
          ...
          <section id="Sandi">
            ...
            <div className="staffDescription">
              ...
              <p>She enjoys spending time with her family, music, cooking and college basketball.</p>
            </div>
          </section>
          <hr />
          <section id="Lawrence">
          ...
          <section id="Richard">
            ...
            <div className="staffDescription">
              <p>
                ...
                years. Upon graduation from Montclair State College (now a University) he worked for a small chemical trading company in NYC
                before landing a job with RCA which was eventually was bought by GE. Richard worked primarily with GE’s
                energy business in California and Virginia before retiring in July 2013.
              </p>

              <p>
                Richard has a lovely wife Deneille (Dene) who is a personal chef and has been married for the last 34 years. Richard and Dene
